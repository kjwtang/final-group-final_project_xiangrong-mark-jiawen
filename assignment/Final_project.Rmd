...
---
The three additional skills we used from the second bulleted list of the rubric:
1. Expansion of ggplot functions (to include more than default characteristics)
2. Use of spatial vector data (sf package) and visualization of spatial data
3. Writing / working with custom R functions (and dplyr verbs / functions)
