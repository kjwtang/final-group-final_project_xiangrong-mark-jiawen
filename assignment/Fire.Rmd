...
Let's go back to the future mentioned in the original paper. We show that fires will increase in response to human activity and climate change, and that logging is inevitable. If these two are not improved, they will have the following conditions:
